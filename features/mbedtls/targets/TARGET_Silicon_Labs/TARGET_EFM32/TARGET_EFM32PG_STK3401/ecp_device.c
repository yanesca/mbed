 ...
 */
__STATIC_INLINE void ecp_crypto_ddata_write(CRYPTO_DDataReg_TypeDef ddataReg, const mbedtls_mpi *mpi)
{
 ...
 */
__STATIC_INLINE int ecp_crypto_ddata_read(CRYPTO_DDataReg_TypeDef ddataReg, mbedtls_mpi *mpi)
{
 ...
 *
 */
int mbedtls_int_ecp_double_jac(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R, const mbedtls_ecp_point *P)
{
    ecc_bigint_t _2YY;
    int          ret;
    (void) grp;
 ...
 * Cost: 1A := 8M + 3S
 */
int mbedtls_int_ecp_add_mixed(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
 ...
 */
static void mbedtls_mpi_div_mod(ecc_bigint_t X, ecc_bigint_t Y, ecc_bigint_t N, ecc_bigint_t R)
{
    uint32_t D[9];
    uint32_t status_reg;
    uint8_t rdata;
 ...
 */
int mbedtls_int_ecp_normalize_jac(const mbedtls_ecp_group *grp, mbedtls_ecp_point *P)
{
    int ret = 0;
 ...
 */
int mbedtls_int_ecp_normalize_jac_many(const mbedtls_ecp_group *grp, mbedtls_ecp_point *T[], size_t t_len)
{
    int ret;
    size_t i;
    ecc_bigint_t *cc;
    ...
    if (t_len < 2)
        return mbedtls_int_ecp_normalize_jac(grp, *T);
...
#endif /* #if defined(MBEDTLS_ECP_FUNCTION_ALT) */
